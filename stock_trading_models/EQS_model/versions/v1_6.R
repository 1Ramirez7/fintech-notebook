...
# - This model is designed to run the ranking for each group in the selected column. 
# - For example, if the sector column is selected then the ranking will be run for each sector.
# - This model also checks for errors like empty data frame.   
# - Also improve modularity and remove redundant/duplicate code.