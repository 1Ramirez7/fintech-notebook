...
ok I tested 6/4/25 and this code does not work with NA values as it ranks NA the highest. I did not test to make sure the calculation was working apart from the NAs issue.
...
This is the first version that is being track via github projects.
